...
const navItems = [
  ...
  { id: 'text', label: 'Text Generation', icon: 'pen', to: '/text-generator' },
  { id: 'image', label: 'Image Generation', icon: 'image', to: '/image-generator' },
  { id: 'summarizer', label: 'File Summarizer', icon: 'file', to: '/file-summarizer' },
  { id: 'chat', label: 'Smart Chat', icon: 'chat', to: '/rag-chat' },
  { id: 'translate', label: 'AI Translator', icon: 'globe', to: '/translator' },
  { id: 'code', label: 'Code Assistant', icon: 'code', to: '/code-assistant' },
]
...
const services = [
  {
    ...
    desc: 'Create social media posts, articles, emails, and any type of content with AI.',
    icon: 'pen',
  ...
  },
  {
    ...
    desc: 'Generate stunning images from your text descriptions.',
    icon: 'image',
  ...
  },
  {
    ...
    desc: 'Upload PDFs and documents to get accurate summaries.',
    icon: 'file',
  ...
  },
  {
    id: 'chat',
    title: 'RAG Chat',
    desc: 'Chat with your own documents and get precise answers.',
    icon: 'chat',
  ...
  },
  {
    ...
    desc: 'Professional translation with semantic understanding, not word-for-word.',
    icon: 'globe',
  ...
  },
  {
    ...
    desc: 'Write code, find bugs, and generate documentation.',
    icon: 'code',
...
const stats = [
  { label: 'Content Generated', value: '142', unit: 'Items', color: '#818cf8' },
  { label: 'Files Summarized', value: '67', unit: 'Files', color: '#34d399' },
  { label: 'Questions Answered', value: '1.2K', unit: 'Questions', color: '#f472b6' },
  { label: 'Remaining Credits', value: '850', unit: 'Tokens', color: '#fb923c' },
]

const recentActivity = [
  { action: 'Text Generation', detail: 'Instagram post for new product', time: '5 minutes ago', icon: 'pen' },
  { action: 'Summarization', detail: 'Q3 Financial Report.pdf', time: '2 hours ago', icon: 'file' },
  { action: 'RAG Chat', detail: '14 questions from contract document', time: 'Yesterday', icon: 'chat' },
]
</script>
      ...
      <div class="content">
        ...
        <div class="welcome-section">
          <div class="welcome-text">
            ...
            <p class="welcome-sub">What would you like to do with AI today?</p>
          </div>
        ...
        <div class="section-header">
          ...
          <p class="section-sub">Powerful tools to boost your productivity</p>
        </div>
        ...
        <div class="services-grid">
          ...
          >
            <div class="service-top">
              ...
              <span v-if="s.tag" :class="['service-tag', { 'tag-new': s.tag === 'New', 'tag-hot': s.tag === 'Popular', 'tag-beta': s.tag === 'Beta' }]">
                {{ s.tag }}
              </span>
            </div>
        ...
        <div class="bottom-grid">
          ...
          <div class="upgrade-card">
            ...
            <p class="upgrade-desc">Get unlimited tokens, advanced models, and priority support.</p>
